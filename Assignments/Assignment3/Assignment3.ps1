...
# For example, you should see PS /home/kali/CSCI1411-Spring2026/Assignments/Assignment3>         #       
# One way is to run "cd ./CSCI1411-Spring2026/Assignments/Assignment3" before starting  #
# the assignment                                                                                           #
